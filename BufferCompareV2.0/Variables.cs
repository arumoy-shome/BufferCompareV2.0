...
namespace WpfApplication1
{
    ...
    public class Variables : INotifyPropertyChanged
    {
        ...
        public Brush ItemBrush
         ...
         public static bool bool_newfilestandard720p50 = false;
         public static bool bool_newfilestandard720p59 = false;
         public static bool bool_newfilestandard1080i50 = false;
         public static bool bool_newfilestandard1080i59 = false;
         public static bool bool_oldfilestandard720p50 = false;
         public static bool bool_oldfilestandard720p59 = false;
         public static bool bool_oldfilestandard1080i50 = false;
         public static bool bool_oldfilestandard1080i59 = false;
         ...
         public static string string_oldfilepath { get; set; }
         ...
         public const int rowsperline1080i50 = 1320;
         public const int rowsperline1080i59 = 1100;
         public const int rowsperline720p50 = 990;
         public const int rowsperline720p59 = 825;
         public static int samplenumvar1 = 0;
         public static int s_samplenumber = 0;
         public static double s_linenumber = 0;
         public static int[,] samplearray1080i50 = new int[Variables.rowsperline1080i50,2];
         public static int[,] samplearray720p59 = new int[Variables.rowsperline720p59,2];
         public static int[,] samplearray720p50 = new int[Variables.rowsperline720p50,2];
         public static int[,] samplearray1080i59 = new int[Variables.rowsperline1080i59,2];
         ...
         public static int firstsample720p = 1284;
         public static int firstsample1080i = 1924;
         public static int[,] newfiledataarray720p50 = new int[Variables.totalrows720p50, 3];
         public static int[,] newfiledataarray720p59 = new int[Variables.totalrows720p59, 3];
         public static int[,] newfiledataarray1080i50 = new int[Variables.totalrows1080i50, 3];
         public static int[,] newfiledataarray1080i59 = new int[Variables.totalrows1080i59, 3];
         public static int[,] oldfiledataarray720p50 = new int[Variables.totalrows720p50, 3];
         public static int[,] oldfiledataarray720p59 = new int[Variables.totalrows720p59, 3];
         public static int[,] oldfiledataarray1080i50 = new int[Variables.totalrows1080i50, 3];
         public static int[,] oldfiledataarray1080i59 = new int[Variables.totalrows1080i59, 3];
